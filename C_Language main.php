...
//echo"Total rows = ".$count."<br/>";
    $x=0;
$qiddata=mysql_query("select qno from ".$_SESSION['examname']."_que;") or die(mysql_error());
...
while($x<5)
{
    $data=mysql_query("Select * from ".$_SESSION['examname']."_que where qno='$newarr[$x]';") or die(mysql_error());
    ...
    ?>           <tr class="question">
                        ...
                        <tr>    
                            ...
                            <?php   $tempans1=$maininfo['ans1'];
                             echo  "<input name='myans[$y]' type='radio' id='$newarr[$x]' value='$tempans1'>".$maininfo['ans1']; ?> 
                            </td>
                            <td class="high" colspan="2">
                            <?php   $tempans2=$maininfo['ans2'];
                            echo  "<input name='myans[$y]' type='radio' id='$newarr[$x]' value='$tempans2'>".$maininfo['ans2']; ?>
                            </td>
                                </tr>
                                <tr>
                            <td class="high" colspan="2">
                            <?php  $tempans3=$maininfo['ans3'];
                            echo  "<input name='myans[$y]' type='radio' id='$newarr[$x]' value='$tempans3'>".$maininfo['ans3']; ?>
                            </td>
                            <td class="high" colspan="2">
                            <?php   $tempans4=$maininfo['ans4'];
                            echo  "<input name='myans[$y]' type='radio' id='$newarr[$x]' value='$tempans4'>".$maininfo['ans4']; ?>
                            </td>
                                </tr>
<?php                   
    }    
